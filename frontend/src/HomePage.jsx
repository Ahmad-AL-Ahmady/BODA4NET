...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* الرأس */}
      <header className="sticky top-0 bg-gradient-to-r from-red-700 via-red-800 to-red-900 shadow-2xl backdrop-blur-sm border-b border-red-600/30 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            {/* Authentication Buttons - Left Side */}
            <div className="flex items-center gap-3">
              <button
                onClick={() => navigate("/auth/login")}
                className="bg-white/10 hover:bg-white/20 text-white font-medium px-4 py-2 rounded-lg transition-all duration-300 border border-white/20"
              >
                تسجيل الدخول
              </button>
              <button
                onClick={() => navigate("/auth/signup")}
                className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-medium px-4 py-2 rounded-lg transition-all duration-300"
              >
                إنشاء حساب
              </button>
            </div>

            {/* BODA 4 NET - Right Side */}
                    ...
                    <div>
                      ...
                      <Select value={amount} onValueChange={setAmount}>
                        ...
                        <SelectContent className="rounded-xl md:rounded-2xl">
                          ...
                          <SelectItem value="250">250 جنيه</SelectItem>
                          <SelectItem value="260">260 جنيه</SelectItem>
                          <SelectItem value="270">270 جنيه</SelectItem>
                          <SelectItem value="280">280 جنيه</SelectItem>
                          <SelectItem value="290">290 جنيه</SelectItem>
                          <SelectItem value="300">300 جنيه</SelectItem>
